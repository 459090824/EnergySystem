...
<body>
        ...
        <div id="pad-wrapper" class="adminList">
            ...
            <div class="col-md-3 form-sidebar">
	                <div class="btn-group toggle-inputs hidden-tablet">
	                    <button id="button-normal" class="glow left active" data-input="normal" style="width: 65px; height: 31px;font-size=12px;" >智能</button>
	        	...
	        	<div class="col-md-10 col-sm-12 col-xs-12 pull-right">
                    ...
                    <a id="dispatch_normal" class="btn-flat success new-product">智能调度</a>
			...
			<div class="row filter-block" style="line-height:60px">
                ...
                <div class="pull-right" style="padding-bottom:9px;padding-right:15px">
                    <a id="dispatch_normal" class="btn-flat success new-product">正常调度</a>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(function(){
           $("#dispatch_normal").click(function(){
               ...
               var end_Time= $("#end").val();
            		   ...
            		   $.ajax({
            			   	url:"<%=basePath %>superadmin/judgeAddNormalDispatch",
   		  					type:"GET",
   		  					async:false,
   		  				 success:function(msg){
   		  					if(msg.success == '1'){
   		  						...
   		  						if(confirm("你确定要将所选设备进行优化调度吗？")){  		  					
            		   				$.ajax({
              							url:"addNormalDispatch",
              							type:"POST",
              							traditional:true,
