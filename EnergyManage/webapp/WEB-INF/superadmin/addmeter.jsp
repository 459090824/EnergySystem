                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>仪器名:</label>
                                <input class="form-control" type="text" id="meter_Name" name="meter_Name"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>仪器编号:</label>
                                <input class="form-control" type="text" id="meter_Code" name="meter_Code"/>
                            </div>
...
//    	                }   
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $buttons.click(function () {
            	window.location.href="onClickAddOtherSystemEquipment";
            });            
        });
 </script>  
</body>
