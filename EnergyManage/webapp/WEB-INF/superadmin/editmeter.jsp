                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                ...
                                <input class="form-control" type="text" id="meter_Name" name="meter_Name" value="${meter.meter_Name}"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>仪器编号:</label>
                                <input class="form-control" type="text" id="meter_Code" name="meter_Code" value="${meter.meter_Code}"/>
                            </div>
                                ...
                                <div class="ui-select span5">
                                    <select id="systemEquipmentType_ID" name="systemEquipmentType_ID" onclick="branchforSubType(this);">                             
                                       <c:forEach items="${systemEquipmentTypes}" var="systemEquipmentType" varStatus="status">
                                       	  <c:if test="${meter.systemEquipmentType_ID == systemEquipmentType.systemEquipmentType_ID}">
                                ...
                                <div class="ui-select span5">
                                    <select id="systemEquipmentSubType_ID" name="systemEquipmentSubType_ID">
                                       <c:forEach items="${systemEquipmentSubTypes}" var="systemEquipmentSubType" varStatus="status">
                                       	  <c:if test="${meter.meterType_ID == systemEquipmentSubType.systemEquipmentSubType_ID}">
                            ...
                            <div class="col-md-12 field-box">
                                ...
                                <div class="ui-select span5">
                                    <select id="collection_ID" name="collection_ID">                                    
                                       <c:forEach items="${dataCollectors}" var="dataCollector" varStatus="status">
                                       	  <c:if test="${meter.collection_ID == dataCollector.collection_ID}">
                                       		<option value="${dataCollector.collection_ID}" selected="selected">${dataCollector.collection_Name}</option>
                                       	  </c:if>
                                       	  <c:if test="${meter.collection_ID != dataCollector.collection_ID}">
                                       	  	<option value="${dataCollector.collection_ID}">${dataCollector.collection_Name}</option>
                                       	  </c:if>
                                       </c:forEach>
                                    </select>
                                </div>
