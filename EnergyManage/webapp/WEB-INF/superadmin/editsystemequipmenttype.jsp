                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>设备类型名:</label>
                                <input type="hidden" name="systemEquipmentType_ID" value="${systemEquipmentType.systemEquipmentType_ID}">
                                <input class="form-control" type="text" id="systemEquipmentType_Name" name="systemEquipmentType_Name" value="${systemEquipmentType.systemEquipmentType_Name}"/>
                            </div>
                            
                             <div class="col-md-12 field-box">
                                <label>类型描述:</label>                 
                                   <div class="col-md-9" style="heigh:1000px;margin-left:-20px">
                                	  <textarea class="form-control" rows="6" id="systemEquipmentType_Desc" name="systemEquipmentType_Desc">${systemEquipmentType.systemEquipmentType_Desc}</textarea>
                            	   </div>                               
                            </div>                                            
     ...
     <script type="text/javascript">
        $(function () {
            ...
            $("#submit-form").click(function () {
                $.ajax({
                	url:"../submitEditSystemEquipmentType",
                	type : "post",
