...
<head>
	<title>房间列表</title>
	<meta name="keywords" content="显示所有房间" />
	<meta name="description" content="显示所有房间" />
        ...
        <div id="pad-wrapper" class="adminList">
            ...
            <!--<div class="row header">
                ...
                <div class="col-md-10 col-sm-12 col-xs-12 pull-right">
                   ...
                   <a href="<%=basePath %>superadmin/onClickAddRoom" class="btn-flat success pull-right">
                        <span>&#43;</span>
                      		  添加房间
                    </a>
                </div>
                ...
                <div class="col-md-12">
                    <table cellpadding="0" cellspacing="0" border="0" class="" id="example">
                        <thead >
                            <tr>
                                <th class="col-md-2 text-center" >
                                   	<span class="line"></span>房间名
                                </th>
                                <th class="col-md-2 text-center">
                                    <span class="line"></span>房间编号
                                </th>
                                <th class="col-md-2 text-center">
                                    <span class="line"></span>所在建筑
                                </th>
                                <th class="col-md-1 text-center">
                                    <span class="line"></span>房间楼层
                                </th>
                                <th class="col-md-2 text-center">
                                    <span class="line"></span>房间面积
                                </th>
                                <th class="col-md-2 text-center">
                                    <span class="line"></span>房间采光指数
                                </th>
                                <th class="col-md-1 text-center">
                        ...
                        <tbody id="showBuilding">
                        	<c:forEach items="${roomUnions}" var="roomUnion" varStatus="status">
                        ...
                        <tr class="first">
                            ...
                            <td class="text-center">
                                ${roomUnion.building.build_Name}
                            </td>
                            <td class="text-center">
                               ${roomUnion.room_Floor}
                            </td>
                            <td class="text-center">
                               ${roomUnion.room_Area}
                            </td>
                            <td class="text-center">
                               ${roomUnion.roomEasementOfLight}
                            </td>
                            <td class="text-center">
                                <i class="table-edit"  name="edit" value="${roomUnion.room_ID}" href="#" title="编辑" style="cursor: pointer;"></i> | <i class="table-delete" name="delete" id="deleteArea${roomUnion.room_ID}" value="${roomUnion.room_ID}" href="" title="删除" style="cursor: pointer;"></i>
                            </td>
    ...
    <script type="text/javascript">
        $(function(){
            $("#showBuilding").bind('click','i', function(e){
                ...
                var room_ID = e.target.getAttribute('value');
                console.log(th);
                console.log(room_ID);
                if (th == 'delete') {
                	$.ajax({
	    				url:"<%=basePath %>superadmin/judgedeleteRoom",
	    				type:"GET",
	    				//data:{_method:'delete'},
	    				//dataType:"json",
	    				async:false,
                ...
                if(th == 'edit' ){
                    $.ajax({
                        ...
                        success:function(msg){
                            if(msg.success == '1'){
                                 if(confirm("你确信要编辑该房间？")){
                                     window.location.href="editRoom/" + room_ID;                         
                                 }else{
                                     alert("已取消！");
                                     return false;
                                 }
  ...
  <script type="text/javascript">
        $(function () {
            ...
            $("#addRoom").click(function () {
                $.ajax({
                	url:"judgeonClickAddRoom",
                	type : "GET",
                	success:function(msg){  
                		if(msg.success == '1'){
                			if(confirm("你确信要添加房间？")){
   							 window.location.href="<%=basePath %>superadmin/onClickAddRoom";    						
   						 }else{
   							 alert("已取消！");
   							 return false;
   						 }
