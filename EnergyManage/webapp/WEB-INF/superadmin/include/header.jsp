...
<body>
    ...
    <header class="navbar navbar-inverse" role="banner">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="<%=basePath %>admin/img/logo.png"></a>
        </div>
        <ul class="nav navbar-nav pull-right hidden-xs">
            ...
            <li class="notification-dropdown hidden-xs hidden-sm">
                ...
                <div class="pop-dialog">
                    ...
                    <div class="body">
                        ...
                        <div class="messages">
                            <a href="#" class="item">
                                <img src="<%=basePath %>admin/img/contact-img.png" class="display" />
                            ...
                            <a href="#" class="item">
                                <img src="<%=basePath %>admin/img/contact-img2.png" class="display" />
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<%=basePath %>superadmin/editAdmin/${sessionScope.user.systemadminid}">个人信息</a></li>
                    <li><a href="#">账号设置</a></li>                    
                    <li><a href="#">导出数据</a></li>
                    <li><a href="<%=basePath %>superadmin/toLoginOut">退出登录</a></li>
                </ul>
            </li>
