                ...
                <div class="col-md-9 with-sidebar">
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            ...
                            <div class="col-md-12 field-box">
                                <label>房间楼层:</label>
                                <input class="form-control" type="text" id="room_Floor" name="room_Floor"/>
                            </div>
                            
                            <div class="col-md-12 field-box">
                                <label>房间面积:</label>
                                <input class="form-control" type="text" id="room_Area" name="room_Area"/>
                            </div>
                            
                            <div class="col-md-12 field-box">
                                <label>房间采光指数:</label>
                                <input class="form-control" type="text" id="roomEasementOfLight" name="roomEasementOfLight"/>
                            </div>                              
