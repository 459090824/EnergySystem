                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>传感器名:</label>
                                <input class="form-control" type="text" id="sensor_Name" name="sensor_Name"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>传感器编号:</label>
                                <input class="form-control" type="text" id="sensor_Code" name="sensor_Code"/>
                            </div>
                            ...
                            <div class="col-md-12 field-box">
                                ...
                                <input class="form-control" type="text" id="sensor_Interval" name="sensor_Interval"/>
                            </div>
