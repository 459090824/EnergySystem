                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>仪表类型名:</label>
                                <input type="hidden" name="meterType_ID" value="${meterType.meterType_ID}">
                                <input class="form-control" type="text" id="meterType_Name" name="meterType_Name" value="${meterType.meterType_Name}"/>
                            </div>
                            
                             <div class="col-md-12 field-box">
                                <label>类型描述:</label>                 
                                   <div class="col-md-9" style="heigh:1000px;margin-left:-20px">
                                	  <textarea class="form-control" rows="6" id="meterType_Desc" name="meterType_Desc">${meterType.meterType_Desc}</textarea>
                            	   </div>                               
                            </div>                                            
