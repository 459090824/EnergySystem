...
<body>
    ...
    <script type="text/javascript">
        $(function(){
            $("#showEquipment").bind('click','i', function(e){
                ...
                if (th == 'delete') {
                	$.ajax({
	    				url:"<%=basePath %>superadmin/judgedeleteEquipment",
	    				type:"GET",
	    				//data:{_method:'delete'},
	    				//dataType:"json",
	    				async:false,
	    				success:function(msg){
	    					if(msg.success == '1'){	 
	    						if(confirm("你确信要删除该设备？")){	    		    							
	    							$.ajax({
	    			    				url:"deleteEquipment/"+equipment_ID,
	    			    				type:"DELETE",
	    			    				async:false,
	    			    				success:function(msg){		    					
	    		    					    if(msg.success == '1'){
                        ...
                        success:function(msg){
                            if(msg.success == '1'){
                                 if(confirm("你确信要编辑该设备？")){
                                     window.location.href="editEquipment/" + equipment_ID;                         
                                 }else{
                                     alert("已取消！");
                                     return false;
                                 }
  ...
  <script type="text/javascript">
        $(function () {
            ...
            $("#addEquipment").click(function () {
                $.ajax({
                	url:"judgeonClickAddEquipment",
                	type : "GET",
                	success:function(msg){  
                		if(msg.success == '1'){
                			if(confirm("你确信要添加设备？")){
   							 window.location.href="<%=basePath %>superadmin/onClickAddEquipment";    						
   						 }else{
   							 alert("已取消！");
   							 return false;
   						 }
