...
<head>
	<title>仪器列表</title>
	<meta name="keywords" content="显示仪器设备" />
	<meta name="description" content="显示所有仪器设备" />
...
<body>
        ...
        <div id="pad-wrapper" class="adminList">
			...
			<div class="row filter-block" style="line-height:60px">
                ...
                <div class="pull-right" style="padding-bottom:9px;padding-right:15px">
                    <a class="btn-flat success new-product" href="#" id="addMeter">添加仪器</a>
                </div>
            </div>
            ...
            <!--<div class="row header">
                ...
                <div class="col-md-10 col-sm-12 col-xs-12 pull-right">
                    ...
                    <a href="<%=basePath %>superadmin/onClickAddMeter" class="btn-flat success pull-right">
                        <span>&#43;</span>
                      		  添加仪器
                    </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table cellpadding="0" cellspacing="0" border="0" class="" id="example">
                        <thead >
                            <tr>
                                <th class="col-md-1 text-center" >
                                   	<span class="line"></span>仪器名
                                </th>
                                <th class="col-md-1 text-center">
                                    <span class="line"></span>仪器编号
                                </th>
                                <th class="col-md-1 text-center">
                                    <span class="line"></span>仪器类型
                                </th>
                                <th class="col-md-1 text-center">
                                    <span class="line"></span>仪器状态
                                </th>
                                <th class="col-md-1 text-center">
                                    <span class="line"></span>仪器连接采集器
                                </th>
                                <th class="col-md-1 text-center">
                                    <span class="line"></span>仪器位置
                                </th>
                                <th class="col-md-1 text-center">
                        ...
                        <tbody id="showMeter">
                        	<c:forEach items="${meterUnions}" var="meterUnion" varStatus="status">                        		
                        <!-- row -->
                        <tr class="first">
                            <td class="text-center">
                             	${meterUnion.meter_Name}
                            </td>
                            <td class="text-center">                            	
                                ${meterUnion.meter_Code}                             
                            </td>
                            <td class="text-center">                            	
                                ${meterUnion.systemEquipmentSubType.systemEquipmentSubType_Name}                             
                            </td> 
                            <td class="text-center">                            	
                                ${meterUnion.state.state_Name}                             
                            </td> 
                            <td class="text-center">                            	
                                ${meterUnion.dataCollector.collection_Name}                             
                            </td> 
                            <td class="text-center">                            	
                                 ${meterUnion.room.room_Name}                             
                            </td>                                                  
                            <td class="text-center">
                                <i class="table-edit"  name="edit" value="${meterUnion.meter_ID}" href="#" title="编辑" style="cursor: pointer;"></i> | <i class="table-delete" name="delete" id="deleteEquipment${meterUnion.meter_ID}" value="${meterUnion.meter_ID}" href="" title="删除" style="cursor: pointer;"></i>
                            </td>
    ...
    <script type="text/javascript">
        $(function(){
            $("#showMeter").bind('click','i', function(e){
                var th = e.target.getAttribute('name');
                var meter_ID = e.target.getAttribute('value');
                console.log(th);
                        ...
                        success:function(msg){
                            if(msg.success == '1'){
                                 if(confirm("你确信要编辑该设备？")){
                                     window.location.href="editMeter/" + meter_ID;                         
                                 }else{
                                     alert("已取消！");
                                     return false;
                                 }
            ...
            $("#addMeter").click(function () {
                $.ajax({
                	...
                	success:function(msg){  
                		if(msg.success == '1'){
                			if(confirm("你确信要添加设备？")){
   							 window.location.href="<%=basePath %>superadmin/onClickAddMeter";    						
   						 }else{
   							 alert("已取消！");
   							 return false;
   						 }
