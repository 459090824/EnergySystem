...
<body>
 ...
 <!--              
            <div class="row filter-block" style="padding-bottom:30px;padding-left:20px">
                ...
                <div class="col-md-9 with-sidebar">
                    <div class="container">
                        <form name="form_uploadImg" action="" method="POST" enctype="multipart/form-data">
                         <div class="col-md-12 field-box">
                            ...
                            <div style="margin-left:135px;">
                                 <div id="preview">
                                    <img id="imghead" width=130 height=130 border=0 src="img/personal-info.png" >  
                            	 </div>
                        ...
                        <input id="fileName" type="hidden" name="fileName" value="">
                            <div class="col-md-12 field-box">
                                <label>用户名:</label>
                                <input class="form-control" type="text" id="username" name="username" onblur="checkUserName()"/>
                             ...
                             <div class="col-md-12 field-box">
                  	    	...
                  	    	<div class="col-md-12 field-box">
                                <label>生日:</label>
                                <input class="laydate-icon"  id="birthday" name="birthday" style="display: inline-block" onclick="laydate()"/>
                            </div>
                                                                                
                            <div class="col-md-12 field-box">
                                <label>密码:</label> 
                                <input class="col-md-9 form-control" type="text" id="password" name="password" onblur="checkPassword()"/>
                                <span id="password_msg"></span>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>Email:</label>
                                <input class="col-md-9 form-control" type="text"  id="email" name="email" onblur="checkEmail()"/>
                                <span id="email_msg"></span>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>电话:</label>
                                <input class="col-md-9 form-control" type="text"  id="telephone" name="telephone" onblur="checkMobilePhone()"/>
                                 <span id="telephone_msg"></span>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>地址:</label>
                                 <input class="col-md-9 form-control" type="text"  id="address" name="address" onblur="checkAddress()"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $buttons.click(function () {
            	window.location.href="onClickAddAuthority";
            });
        });
    </script>
