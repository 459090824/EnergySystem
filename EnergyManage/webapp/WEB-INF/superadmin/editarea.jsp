                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                ...
                                <input class="form-control" type="text" id="region_Name" name="region_Name" value="${area.region_Name}"/>
                            </div>
                                ...
                                <div class="ui-select span5">
                                    <select id="park_ID" name="park_ID">
                                       <c:forEach items="${parks}" var="park" varStatus="status">
                                    		<c:if test="${area.park_ID == park.park_ID}">
                            ...
                            <div class="col-md-12 field-box">
                                <label>地址:</label> 
                                <input class="col-md-9 form-control" type="text" id="region_Addr" name="region_Addr" value="${area.region_Addr}"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>联系人:</label>
                                <input class="col-md-9 form-control" type="text"  id="region_Contact" name="region_Contact" value="${area.region_Contact}"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>电话:</label>
                                <input class="col-md-9 form-control" type="text"  id="region_Tel" name="region_Tel" value="${area.region_Tel}"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>联系人邮箱:</label>
                                <input class="col-md-9 form-control" type="text"  id="region_Email" name="region_Email" value="${area.region_Email}"/>
                            </div>
