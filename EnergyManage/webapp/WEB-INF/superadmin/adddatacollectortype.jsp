                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>采集器类型名:</label>
                                <input class="form-control" type="text" id="collectionType_Name" name="collectionType_Name"/>
                            </div>
                            
                             <div class="col-md-12 field-box">
                                <label>类型描述:</label>                 
                                   <div class="col-md-9" style="heigh:1000px;margin-left:-20px">
                                	  <textarea class="form-control" rows="6" id="collectionType_Desc" name="collectionType_Desc"></textarea>
                            	   </div>                               
                            </div>                                            
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#submit-form").click(function () {
                $.ajax({
                	url:"submitAddDataCollectorType",
                	type : "post",
