...
<head>
	<title>能源列表</title>
	<meta name="keywords" content="显示所有能源" />
	<meta name="description" content="显示所有能源" />
...
<body>
        ...
        <div id="pad-wrapper" class="adminList">
            ...
            <!--<div class="row header">
                ...
                <div class="col-md-10 col-sm-12 col-xs-12 pull-right">
                    ...
                    <a href="<%=basePath %>superadmin/onClickAddEnergy" class="btn-flat success pull-right">
                        <span>&#43;</span>
                      		  添加能源
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table cellpadding="0" cellspacing="0" border="0" class="" id="example">
                        <thead >
                            <tr>
                                <th class="col-md-2 text-center" >
                                   	<span class="line"></span>能源名
                                </th>
                                <th class="col-md-4 text-center">
                                    <span class="line"></span>能源描述
                                </th>
                        ...
                        <tbody id="showEnergy">
                        	<c:forEach items="${energyTypes}" var="energyType" varStatus="status">                        		
                        <!-- row -->
                        <tr class="first">
                            <td class="text-center">
                             	${energyType.energyType_Name}
                            </td>
                            <td class="text-center">                          	
                                ${energyType.energyType_Desc}                             
                            </td>                                                  
                            <td class="text-center">
                                <i class="table-edit"  name="edit" value="${energyType.energyType_ID}" href="#" title="编辑" style="cursor: pointer;"></i> | <i class="table-delete" name="delete" id="deleteEnergyType${energyType.energyType_ID}" value="${energyType.energyType_ID}" href="" title="删除" style="cursor: pointer;"></i>
                            </td>
    ...
    <script type="text/javascript">
        $(function(){
            $("#showEnergy").bind('click','i', function(e){
                var th = e.target.getAttribute('name');
                var energyType_ID = e.target.getAttribute('value');
                console.log(th);
                console.log(energyType_ID);
                if (th == 'delete') {
                	$.ajax({
	    				url:"<%=basePath %>superadmin/judgedeleteEnergyType",
	    				type:"GET",
	    				//data:{_method:'delete'},
	    				//dataType:"json",
	    				async:false,
	    				success:function(msg){
	    					if(msg.success == '1'){	 
	    						if(confirm("你确信要删除该能源类型？")){	    		    							
	    							$.ajax({
	    			    				url:"deleteEnergyType/"+energyType_ID,
	    			    				type:"DELETE",
	    			    				async:false,
	    			    				success:function(msg){		    					
	    		    					    if(msg.success == '1'){
	    		    						   alert("删除成功！");
	    		    						   window.location.href="allEnergy"; 
	    			    				    }else{
	    		    		    			      alert("删除失败！");	
	    		    		    			      }
	    		    						return false;
                ...
                if(th == 'edit' ){
                    $.ajax({
                        ...
                        success:function(msg){
                            if(msg.success == '1'){
                                 if(confirm("你确信要编辑该能源类型？")){
                                     window.location.href="editEnergyType/" + energyType_ID;                         
                                 }else{
                                     alert("已取消！");
                                     return false;
                                 }
  ...
  <script type="text/javascript">
        $(function () {
            ...
            $("#addEnergy").click(function () {
                $.ajax({
                	url:"judgeonClickAddEnergy",
                	type : "GET",
                	success:function(msg){  
                		if(msg.success == '1'){
                			if(confirm("你确信要添加能源类型？")){
   							 window.location.href="<%=basePath %>superadmin/onClickAddEnergy";    						
   						 }else{
   							 alert("已取消！");
   							 return false;
   						 }
