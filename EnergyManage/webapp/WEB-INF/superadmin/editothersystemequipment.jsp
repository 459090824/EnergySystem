                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>设备名:</label>
                                 <input type="hidden" name="systemEquipmentID" value="${otherSystemEquipment.systemEquipmentID}">
                                <input class="form-control" type="text" id="systemEquipmentName" name="systemEquipmentName" value="${otherSystemEquipment.systemEquipmentName}"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>设备编号:</label>
                                <input class="form-control" type="text" id="systemEquipmentCode" name="systemEquipmentCode" value="${otherSystemEquipment.systemEquipmentCode}"/>
                            </div>
                                ...
                                <div class="ui-select span5">
                                    <select id="systemEquipmentType_ID" name="systemEquipmentType_ID" onclick="branchforSubType(this);">                                   	
                                       <c:forEach items="${systemEquipmentTypes}" var="systemEquipmentType" varStatus="status">
                                       	  <c:if test="${otherSystemEquipment.systemEquipmentType_ID == systemEquipmentType.systemEquipmentType_ID}">
                                ...
                                <div class="ui-select span5">
                                    <select id="systemEquipmentSubType_ID" name="systemEquipmentSubType_ID">                                    	
                                       <c:forEach items="${systemEquipmentSubTypes}" var="systemEquipmentSubType" varStatus="status">
                                       	  <c:if test="${otherSystemEquipment.systemEquipmentTypeID == systemEquipmentSubType.systemEquipmentSubType_ID}">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#submit-form").click(function () {
                $.ajax({
                	url:"../submitEditOtherSystemEquipment",
                	type : "post",
