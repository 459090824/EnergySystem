                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>类型名:</label>
                                <input type="hidden" name="buildType_ID" value="${buildingType.buildType_ID}">
                                <input class="form-control" type="text" id="buildType_Name" name="buildType_Name" value="${buildingType.buildType_Name}"/>
                            </div>
                            
                             <div class="col-md-12 field-box">
                                <label>类型描述:</label>                 
                                   <div class="col-md-9" style="heigh:1000px;margin-left:-20px">
                                	  <textarea class="form-control" rows="6" id="buildType_Desc" name="buildType_Desc">${buildingType.buildType_Desc}</textarea>
                            	   </div>                               
                            </div>                                            
