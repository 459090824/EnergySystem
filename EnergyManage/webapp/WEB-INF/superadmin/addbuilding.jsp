                ...
                <div class="col-md-9 with-sidebar">
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            ...
                            <div class="col-md-12 field-box">
                                <label>建筑地上层数:</label>
                                <input class="form-control" type="text" id="buildUp_Floor" name="buildUp_Floor"/>
                            </div>
                            
                            <div class="col-md-12 field-box">
                                <label>建筑地下层数:</label>
                                <input class="form-control" type="text" id="buildDown_Floor" name="buildDown_Floor"/>
                            </div>
