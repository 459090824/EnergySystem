...
<head>
	<title>手动设备列表</title>
	<meta name="keywords" content="显示所有手动控制设备" />
	<meta name="description" content="显示所有手动控制设备" />
...
<body>
            ...
            <div class="row filter-block" style="line-height:60px">
  				<div class="col-md-3 form-sidebar">
	                <div class="btn-group toggle-inputs hidden-tablet">
	                    <button id="button-auto" class="glow left" data-input="normal" style="width: 65px; height: 31px;font-size=12px;" >自动</button>
	                    <button id="button-hm" class="glow right active" data-input="inline" style="width: 65px; height: 31px;font-size=12px;">手动</button>
	                </div>
	       		 </div>
			</div>
  <!--          <div class="pull-right" style="padding-bottom:9px;padding-right:15px">
                        	...
                        	<c:forEach items="${equipmentUnions}" var="equipmentUnion" varStatus="status">
	                          ...
	                          <tr>
                            	...
                            	<td class="text-center">
	                                ...
	                                <td class="center">
	                                	<i class="table-delete" name="delete" id="deleteNavigation${equipmentUnion.equipment_ID}" value="${equipmentUnion.equipment_ID }" href="" title="删除" style="cursor: pointer;"></i>
	                                </td>
	                            </tr>    
                        	</c:forEach>
    ...
    <script type="text/javascript">
    	$(function(){
    		$("#showHMEquipment").bind('click','i', function(e){
	    				...
	    				success:function(msg){
	    					if(msg.success == '1'){	 
	    						if(confirm("你确信要将该设备移除列表？")){	    		    							
	    							$.ajax({
	    			    				url:"deleteEquipmentHmModel/"+equipment_ID,
	    			    				type:"DELETE",
	    			    				async:false,
	    			    				success:function(msg){		    					
	    		    					    if(msg.success == '1'){
