                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>采集器名:</label>
                                <input class="form-control" type="text" id="collection_Name" name="collection_Name"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>采集器编号:</label>
                                <input class="form-control" type="text" id="collection_Code" name="collection_Code"/>
                            </div>
                            ...
                            <div class="col-md-12 field-box">
                                ...
                                <input class="form-control" type="text" id="collect_Interval" name="collect_Interval"/>
                            </div>
