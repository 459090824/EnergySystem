                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                ...
                                <input class="form-control" type="text" id="sensor_Name" name="sensor_Name" value="${sensor.sensor_Name}"/>
                            </div>
                            <div class="col-md-12 field-box">
                                <label>传感器编号:</label>
                                <input class="form-control" type="text" id="sensor_Code" name="sensor_Code" value="${sensor.sensor_Code}"/>
                            </div>
                                ...
                                <div class="ui-select span5">
                                    <select id="systemEquipmentType_ID" name="systemEquipmentType_ID" onclick="branchforSubType(this);">                             
                                       <c:forEach items="${systemEquipmentTypes}" var="systemEquipmentType" varStatus="status">
                                       	  <c:if test="${sensor.systemEquipmentType_ID == systemEquipmentType.systemEquipmentType_ID}">
                                ...
                                <div class="ui-select span5">
                                    <select id="systemEquipmentSubType_ID" name="systemEquipmentSubType_ID">
                                       <c:forEach items="${systemEquipmentSubTypes}" var="systemEquipmentSubType" varStatus="status">
                                       	  <c:if test="${sensor.sensorType_ID == systemEquipmentSubType.systemEquipmentSubType_ID}">
                            ...
                            <div class="col-md-12 field-box">
                                <label>传感器采集数据周期:</label>
                                <input class="form-control" type="text" id="sensor_Interval" name="sensor_Interval" value="${sensor.sensor_Interval}"/>
                            </div>
