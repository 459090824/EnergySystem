                    ...
                    <div class="container">
                        <form id="new_user_form1" class="new_user_form">
                            <div class="col-md-12 field-box">
                                <label>类型名:</label>
                                <input type="hidden" name="equipmentType_ID" value="${equipmentType.equipmentType_ID}">
                                <input class="form-control" type="text" id="equipmentType_Name" name="equipmentType_Name" value="${equipmentType.equipmentType_Name}"/>
                            </div>
                            
                             <div class="col-md-12 field-box">
                                <label>类型描述:</label>                 
                                   <div class="col-md-9" style="heigh:1000px;margin-left:-20px">
                                	  <textarea class="form-control" rows="6" id="equipmentType_Desc" name="equipmentType_Desc">${equipmentType.equipmentType_Desc}</textarea>
                            	   </div>                               
                            </div>                                            
