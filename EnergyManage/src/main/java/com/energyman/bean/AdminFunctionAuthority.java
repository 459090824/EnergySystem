...
public class AdminFunctionAuthority {
	...
	private List<Authority> adminFunctionAuthorityList;
	...
	public List<Authority> getAdminFunctionAuthorityList() {
		return adminFunctionAuthorityList;
	}

	public void setAdminFunctionAuthorityList(List<Authority> adminFunctionAuthorityList) {
		this.adminFunctionAuthorityList = adminFunctionAuthorityList;
	}
